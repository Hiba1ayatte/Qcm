...
// Exemple de requête pour récupérer les questions de la base de données
...
// Exemple de récupération des questions dans un tableau
$questions = array();
        ...
        <div class="Qcm swiper">
            ...
            foreach ($questions as $question) { ?>
                <div class="container swiper-slide ">
                    ...
                    <div class="reponse">
                        <input type="text" title="Si il y a 2 '?' Si Non entre Une seul Réponse " name="reponse[<?php echo $question['id'] ?>]" placeholder="?-?">
                        <button type="submit" name="submit[<?php echo $question['id'] ?>]"><i class="fa-sharp fa-solid fa-check "></i></button>
                    </div>
